  ...
  <q-layout container style="width: 100%; height: 100%; min-height:calc(100vh - 50px);" view="hHh Lpr fff">
    ...
    <q-page-container>
      <q-page class="q-form-builder-page">
        ...
        <draggable v-model="fields" @change="onChange" :options="destinationOptions"
          ...
          <div class="editable-element-container" v-for="(field, idx) in fields" :key="idx">
            <editable-element v-model="fields[idx]" @click="selectForEdit"
              :class="{ 'selected': isSelectedForEdit(idx) }" :ref="fields[idx].cid" />
