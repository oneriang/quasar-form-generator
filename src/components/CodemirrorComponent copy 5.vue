<script setup>
  ...
  onMounted(() => {
    ...
    let editor1 = monaco.editor.create(editor.value, {
      value: "function hello() {\n\talert('Hello world!');\n}",
      language: 'javascript',
    });
    // // editor1.dispose();
    // let model = monaco.editor.createModel("console.log('hello,world')", "javascript");
    // // editor1.setModel(model);
    // // const model=monaco.editor.createModel("hahahaha","javascript");
    // let monacoInstance = monaco.editor.create(editor.value, {
    //   model: model
    // })
