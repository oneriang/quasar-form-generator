...
export default {
    ...
    methods: {
        ...
        bodyDown(ev) {
            ...
            if (this.dragHandle && target.getAttribute('data-drag-handle') !== this._.uid.toString()) {
                return;
            }

            if (this.dragCancel && target.getAttribute('data-drag-cancel') === this._.uid.toString()) {
                return;
            }
    ...
    computed: {
        ...
        rect() {
            return {
                ...
                height: this.height==='auto'?'auto':Math.round(this.height),
            };
        },
    },
